...
impl UI {
    ...
    where T: std::fmt::Display {
        ...
        let text_len = text_str.chars().count() as i32;
    ...
    pub fn render_lost_ui(&self, game: &Game) {
        ...
        self.render_text_align_center(&mut out, "Game Over! You ran out of attempts.".red(), start_row);
        
        self.render_text_align_center(&mut out, "", start_row + 1);
        
        self.render_text_align_center(&mut out, "The secret code was:".white(), start_row + 2);
        
        let secret_code_text = format!("{:?}", game.secret_code);
        self.render_text_align_center(&mut out, &secret_code_text.blue(), start_row + 3);
        
        self.render_text_align_center(&mut out, "", start_row + 4);
        
        self.render_text_align_center(&mut out, "Press any key to exit...".dim(), start_row + 5);
    ...
    pub fn render_win_ui(&self, game: &Game) {
        ...
        self.render_text_align_center(&mut out, "Congratulations! You won!".green(), start_row);
